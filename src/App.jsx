...
const App = () => {
  ...
  return (
    <div>
      <Navbar />
      <div style={{backgroundImage: "url(" + random.strMealThumb + ")"}} className="my-custom-top-banner mt-[-5em]">
         <h1 className='text-2xl md:text-4xl text-gray-800'>Find Out Your Recipes Today!</h1>
      </div> 
