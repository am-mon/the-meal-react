      ...
      <div>
        <div className='flex flex-wrap justify-center'>
          ...
          <div className='w-[100%] md:w-[50%] lg:w-[50%] box-border px-0 pr-2 md:pl-5 mb-5 '>
            ...
            <p className='mt-4 text-sm italic text-gray-400 '>Reference: <a href={recipe.strSource} target="_blank" className='mt-4 text-sm italic hover:text-gray-800 break-words'>{recipe.strSource}</a></p>
          </div>
        </div>
      </div>
    )
